...
#        rmof= rmOutliers(roi[fwi:fwi+blksz])
#        rmob= rmOutliers(roi[bwi:bwi+blksz])
...
#    return _N.array([0., 0., 0., 0.]), [-1], smpv_f + smpv_b, blks - smpv_f + blks - smpv_b, ssb, trdb
...
def rmOutlier(mdat, per=0.0, sd=0.0, col=0):
   """
